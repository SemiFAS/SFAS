...
TOOLS=("gcc" "g++" "make" "cmake" "gawk" "bc" "sed" "automake" "autoconf" "flex" "bison")
...
${dir}/install_valgrind.sh >/dev/null 2>&1 || error "Valgrind"

# Install Criterion from submodule
${dir}/install_criterion.sh >/dev/null 2>&1 || error "Criterion"